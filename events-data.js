/* ============================================================
   ...
   in links like: event.html?id=greenova2026).
   images: add as many as you like — greenova1, greenova2, greenova3...
   the carousel will pick them all up automatically.
   ============================================================ */
window.EVENTS = {

  greenova2026: {
    title: "World Environment Day &mdash; GREENOVA 2k26",
    date: "5 June, 2026",
    venue: "Loknete Shamrao Peje Government College of Engineering, Ratnagiri",
    cover: "images/events/greenova1.jpg",
    images: [
    ...
    body: [
      ...
      "We were honored to have officers from the Forest Department as our special guests. They shared valuable insights on forest conservation, biodiversity protection, and the role of young people in preserving the environment. Various activities were conducted to encourage environmental responsibility and inspire students to contribute to a greener future.",
      "The celebration concluded with a renewed pledge to protect and conserve our environment for future generations."
    ],
    quote: ""
  },
  ...
  autoexpo2026: {
    ...
    body: [
      ...
      "The event was entirely sponsorship-based, demonstrating strong industry and community support without institutional financial dependence. Auto Expo 2026 witnessed an impressive footfall of over 2,000&ndash;3,000 visitors, making it one of the biggest and most engaging student-led events. The expo also received extensive coverage from local news channels and media platforms, while online event-related content crossed 1 million+ views, significantly expanding its reach and impact.",
      "The event provided a unique platform to showcase modified cars, bikes, and high-tech automotive modifications, encouraging awareness and appreciation of modern automotive trends, engineering creativity, and innovation. Auto Expo 2026 brought together students from various colleges, automotive enthusiasts, modified vehicle owners, and industry-connected individuals on a single platform, fostering networking, collaboration, and knowledge exchange.",
      "By connecting passionate automobile enthusiasts with educational institutions, Team Gladiator aimed to inspire innovation, strengthen industry-academia interaction, and promote a healthy and responsible automotive culture among young engineers and enthusiasts."
    ],
    quote: "A big thank you to all participants, organizers, and the audience for making the Auto-Expo a success!"
  },
  ...
  aetherx2026: {
    ...
    body: [
      ...
      "Participants worked around the clock, guided by industry mentors, to design and build working prototypes, sharpening both their technical and problem-solving skills in a high-energy, competitive environment."
    ],
    quote: "A big thank you to all participants, organizers, and the audience for making the AetherX Hackathon a success!"
  },
  ...
  lic2026: {
    ...
    quote: "Thank you all for making this event a success! Your support and participation were greatly appreciated."
  },
  ...
  raaga2026: {
    ...
    date: "13 May, 2026",
    venue: "Loknete Shamrao Peje Government College of Engineering, Ratnagiri",
    cover: "images/events/raaga20261.jpg",
    images: [
      "images/events/raaga20261.jpg",
      "images/events/raaga20262.jpg",
      "images/events/raaga20263.jpg"
    ],
    body: [
      "Raaga 2026, the Annual Day Function of our Institute, was organized to celebrate the talent, culture, achievements, and togetherness of our institute through a vibrant lineup of cultural performances and activities."
    ],
    quote: "Thank you all for making this event a success! Your support and participation were greatly appreciated."
  },
  ...
  raaga2025: {
    ...
    date: "20 June, 2025",
    venue: "Loknete Shamrao Peje Government College of Engineering, Ratnagiri",
    cover: "images/events/raaga20251.jpg",
    images: ["images/events/raaga20251.jpg", "images/events/raaga20252.jpg"],
    body: [
      "Our college fest featuring a wide range of dance and music events, including formal and informal performances, singing, and rock band performances."
    ],
    quote: ""
  },
