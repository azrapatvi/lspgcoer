/* ============================================================
   FOOD TECHNOLOGY & MANAGEMENT DEPARTMENT — EVENTS DATA
   Add a new event by adding a new key below (use it as the id
   in links like: ftm_event.html?id=foodevent2024).
...
window.FTM_EVENTS = {
  ...
  industrialvisit2025: {
    title: "Industrial Visit &ndash; 2025",
    date: "2025",
    venue: "Loknete Shamrao Peje Government College of Engineering, Ratnagiri",
    cover: "images/events/FTM_Event4.jpeg",
    images: ["images/events/FTM_Event4.jpeg"],
    body: [
      "The Department of Food Technology and Management arranged an industrial visit under the guidance of Dr. Dhanashree Kulkarni Madam, giving students first-hand exposure to food processing operations.",
    ],
    quote: "",
  },
};
